		...
		<div class="container">
			...
			<!-- <div id="main4" align=center>
				...
				<div class="info2">
					...
					<div align=right style="color:#7A07EE; margin-top:10px;">
					<a href="https://www.netflix.com/kr/">넷플릭스 바로가기
	...
	<div id="con1">
		<div class="container">
			...
			<div id="main3" align=center>
				...
				<div class="info3">
					<div id="leader">
						...
						<div class="personbottom">퍼즐장 나!!</div>
					</div>
					<div id="member1">
						<div class="persontop">
							<img src="/img/puzzle.png">
						</div>
						<div class="personbottom">퍼즐원 누구님</div>
					</div>
					<div id="member2">
						<div class="persontop">
							<img src="/img/puzzle.png">
			...
			<div id="main3" align=center>
				<div class="ttop" style="width: 70%; height: 80px;">
					...
					<div class="topr" align=left>
						<div style="height: 55%; font-size: 22px; padding-top: 5px;">왓챠
							프리미엄 파티</div>
						<div style="height: 45%;">으로 이용중</div>
					</div>
				</div>
				<div class="info3">
					<div id="leader">
						...
						<div class="personbottom">퍼즐장 누구님</div>
					</div>
					<div id="member1">
						<div class="persontop">
							<img src="/img/puzzle.png">
					...
					<div id="member3">
						...
						<div class="personbottom">퍼즐원 나!!</div>
					</div>
				</div>
			</div>
			<!-- 퍼즐장 정산 -->
			<div id="main3" align=center>
				...
				<div class="info">
					<div class="row1" align=left>
						<img src="/img/ifleader1.png"> <img src="/img/ifleader2.png">
					</div>
					<div class="row2">
						<div class="infoname">정산 날짜</div>
						<div class="infodetail">
			...
			<div id="main4" align=center>
				...
				<div class="info2">
					<div class="row4">
						<div class="infoname">ID</div>
						<div class="infodetail">OTT 아이디</div>
					</div>
					<div class="row5">
						<div class="infoname">PW</div>
						<div class="infodetail">OTT 비밀번호</div>
					...
					<div align=right style="color: #7A07EE; margin-top: 10px;">
						<a href="https://watcha.com/">왓챠 바로가기 <img
							style="width: 16px; height: 16px; margin-bottom: 3px;"
							src="/img/arr.png"></a>
					</div>
				</div>
