...
<body>
<form action="/joinBoss.party" method="post">
    <div id="container" align=center>
        <div style="width: 50%; min-width:450px; padding-top: 1%;">
            <div style="float: left; width: 50%;" align=left>
        ...
        <div align=center style="width: 100%; padding-top: 30px;">
            ...
            <div style="border-radius: 25px; border: none; background-color: #ffffff; width: 40%; min-width:400px; height:50px; color: #121212; font-weight: bold; font-size: 20px; line-height: 45px; padding-left: 20px;" align=left>
                ID
            ...
            <input type="hidden" name="ott" value="netflix">
            <button id="next" type="submit" class="bigbtn" onclick = "location.href = '/puzzle/addnetleader4.jsp'" style="margin-top:20px;">다음</button>
        </div>
    </div>
    </form>
</body>
