		...
		<div class="container">
			...
			<div id="main5" align=center>
				<div class="ttop" style="width: 70%; height: 80px;">
					<div class="topl">
						<img src="/img/n.png"
							style="width: 3.5rem; height: 3.5rem; margin-top: 5px; margin-left: -20px;">
					</div>
					<div class="topr" align=left>
						<div style="height: 55%; font-size: 22px; padding-top: 5px;">넷플릭스
							프리미엄 파티</div>
						<div style="height: 45%;">${boss}${member}으로이용중</div>
					</div>
				</div>
				...
				<div class="info3" style="margin-top: 20px; border: 1.5px solid #FFca18;">
					<div id="leader">
						<div class="persontop">
							<img src="/img/33.png">
						</div>
