		...
		<div id="container" align=center>
			<div style="width: 50%; min-width: 450px; padding-top: 1%;">
				<div style="float: left; width: 50%;" align=left>
					<a href="/puzzle/addpuzzle.jsp"><img id="back"
			...
			<div align=center style="width: 100%; padding-top: 4%;">
				<img src="/img/addmemberfee2.png" alt=""
					style="margin-top: 30px; width: 40%; min-width: 450px;"><br>
				<img src="/img/addmember.png" alt=""
					style="margin-top: 30px; width: 40%; min-width: 450px;"><br>
					 <input type="hidden" name="ott" value="watcha">
				<button id="next" type = "button" class="bigbtn"
					style="margin-top: 40px; margin-bottom: 40px;">다음</button>
			</div>
		</div>
	</form>
</body>
