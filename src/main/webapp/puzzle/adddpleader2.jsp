    ...
    <div id="container" align=center>
        <div style="width: 50%; min-width:450px; padding-top: 1%;">
            <div style="float: left; width: 50%;" align=left>
                <a href="/puzzle/adddpleader1.jsp"><img id="back" src="/img/back.png" style="width: 4%; min-width:15px;"></a>
            </div>
        ...
        <div align=center style="width: 100%; padding-top: 30px;">
            ...
            <button id="next" class="bigbtn" onclick = "location.href = '/puzzle/adddpleader3.jsp'" style="margin-top:40px;">다음</button>
        </div>
    </div>
</body>
<script>
