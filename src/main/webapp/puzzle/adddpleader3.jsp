    ...
    <div id="container" align=center>
        <div style="width: 50%; min-width:450px; padding-top: 1%;">
            <div style="float: left; width: 50%;" align=left>
                <a href="/puzzle/adddpleader2.jsp"><img id="back" src="/img/back.png" style="width: 4%; min-width:15px;"></a>
            </div>
        ...
        <div align=center style="width: 100%; padding-top: 30px;">
            <img src="/img/adddpleader4.png" style="margin-top:30px; margin-bottom:30px; width: 40%; min-width:450px;"><br>
            <div style="border-radius: 25px; border: none; background-color: #fff; width:400px; height:50px; color: #121212; font-weight: bold; font-size: 20px; line-height: 45px; padding-left: 20px;" align=left>
                ID
                <input id="id" name = "ottId" type="text" placeholder="디즈니+ 아이디 입력" style="border: none; background-color: #fff; width: 80%;">
            </div>
            ...
            <div style="border-radius: 25px; border: none; background-color: #ffffff; width:400px; height:50px; color: #121212; font-weight: bold; font-size: 20px; line-height: 45px; padding-left: 20px;" align=left>
                PW
                <input id="pw" name = "ottPw" type="text" placeholder="디즈니+ 비밀번호 입력" style="border: none; background-color: #fff; width: 80%;">
            </div>
            <div style="width: 50%; margin-left: 2%; color: #ededed; width:400px; margin-bottom:30px;" align=left>공유 가능한 안전한 비밀번호를 사용해주세요</div>
        
            <input type="hidden" name="ott" value ="disney">
...
$("#next").on("click", function () {
   ...
   Swal.fire({
       background: '#121212',
       html: "디즈니플러스 퍼즐장으로 매칭을 시작합니다.<br>매칭이 완료되면 MY퍼즐에서 확인 가능해요!",
       color: '#ededed',
       showCancelButton: true,
       confirmButtonColor: '#7a07ee',
       cancelButtonColor: '#999999',
