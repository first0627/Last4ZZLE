         ...
         <div class="col-12 col-md-6">
            ...
            <div id="main2">
               화질도 낮고 비싼 요금제, 그동안 혼자 보고 계셨나요?<br> 이제 포즐과 함께 걱정 말고 공유하세요!
                  ...
                  <c:choose>
                  <c:when test="${loginID != null}">
                  <a class="nav-link" href="/ifPartyExists.party"><button class="bigbtn">서비스 시작하기</button></a>
                  </c:when>
                  <c:otherwise>
                  <a id="nopuzzle" class="nav-link" style="padding:0px;"><button class="bigbtn">서비스 시작하기</button></a>
                  </c:otherwise>
                  </c:choose>
            <div id="main3">이용 가능 OTT 서비스</div>
            <div id="main4">
               <img id="ott1" src="/img/Group22.png"> <img id="ott2" src="/img/Group23.png"> <img id="ott3"
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 mb-5" align=center>
            <img id="mainimg" src="/img/group33.png" style="width:400px; height:380px;">
         </div>
...
<div id="con3" align=center>
   <div class="row" align=center style="width:100%;">
         ...
         <div id="main11" align=center>
          ...
          <a href="/contents/main.jsp"><button class="lookaround">포즐피디아 구경하기</button></a>
