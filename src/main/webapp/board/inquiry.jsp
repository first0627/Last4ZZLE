         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
               ...
               <ol class="nav-pills navbar-nav w-100 justify-content-end centered" id=po>
                  <li class="nav-item"><a class="nav-link active" aria-current="page" style="background-color:inherit;" href="/list.board?cpage=1">고객센터</a></li>
                  <c:choose>
                  <c:when test="${loginID != null}">
         ...
         <nav class="navbar navbar-expand navbar-light"
            style="background-color: #121212; padding: 0%; margin-bottom: 4%; font-weight: 700;">
               <div class="collapse navbar-collapse" id="navbarNav">
                  ...
                  <a class="nav-link" href="/list.qnaboard?cpage=1"
                     style="color: #7A07EE; width: 50%;">문의</a>
               </div>
         </nav>
      </div>
            ...
            <div id="notice" align=center
               ...
               <div id="row1"
                  ...
                  <input id="title" name="title" class="editable" type="text"
                     value="${dto.title}" style="width:100%;" disabled>
               </div>
               <div id="row2"
...
$(".rdelete").on("click", function(){
   let result = confirm("댓글을 삭제하시겠어요?");
   if(result){
      $.ajax({
         url:"/delete.reply",
         data:{rseq:$(this).val()}
