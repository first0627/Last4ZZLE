            ...
            <div class="container-fluid"
               ...
               <div class="collapse navbar-collapse" id="navbarNav"
                  ...
                  <a class="nav-link" href="/list.qnaboard?cpage=1"
                     style="color: #a959ff; width: 200px;">문의</a>
               </div>
            </div>
         </nav>
      </div>
         ...
         <nav class="navbar navbar-expand navbar-light"
            style="background-color: #121212; padding: 0%; margin-bottom: 4%; font-weight: 700;">
               <div class="collapse navbar-collapse" id="navbarNav">
                  ...
                  <a class="nav-link" href="/list.qnaboard?cpage=1"
                     style="color: #a959ff; width: 50%;">문의</a>
               </div>
         </nav>
      </div>
	   ...
	   okBtn.on("click", function() {
		   Swal.fire({
		       ...
		       if (result.isConfirmed) {
		    	$("#formid").attr("action", "/update.qnaboard").submit();   
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<ol class="nav-pills navbar-nav w-100 justify-content-end centered"
				...
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/list.board?cpage=1"
					style="background-color: inherit;">고객센터</a></li>
				<c:choose>
					<c:when test="${loginID != null}">
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="#"
...
<div id="con1">
	<div class="container" style="background-color: #121212;">
		...
		<div class="col-12 d-block d-md-none">
			<div
				style="font-size: 40px; color: white; margin-bottom: 50px; padding-left: 3%; font-weight: 700;">고객센터</div>
			<nav class="navbar navbar-expand navbar-light"
				style="background-color: #121212; padding: 0%; margin-bottom: 4%; font-weight: 700;">
				<div class="collapse navbar-collapse" id="navbarNav">
					<a class="nav-link active" aria-current="page"
		...
		<div id="row8">
			<div class="rcontainer" style="color: white;">
				...
				<div id="rrow3" style="height: 85%;">
					...
					<c:if test="${loginID eq 'admin@admin.com'}">
						<div id="rrow4"
							style="float: left; width: 20%; height: 100%; padding-top: 2%;"
							align=right>
							<button type="button" class="redit">수정</button>
							<button type="button" value="${i.seq}" name="rseq"
								class="rdelete" style="margin-left: 5%;">삭제</button>
