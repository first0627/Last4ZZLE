...
<div id="con1">
      ...
      <input type="hidden" value="${dto.seq}" name=seq>
        <div id="notice" align=center style="color: #ededed; width: 100%; height: 80%;">
            <div id="row1" style="font-size : 25px; width: 100%; padding-bottom: 1%; border-bottom: 1px solid #2E2E2E; padding-left: 20px;" align=left>
            <input id="title" name="title" class="editable" type="text" value="${dto.title}" style="width:100%;" disabled>
            </div>
             <div id="row2" style="width: 100%; font-size : 12px; height: 30px; padding-bottom: 0.5%; border-bottom: 2px solid #2E2E2E; padding-right: 20px; margin-top: 0.5%;" align=right>
         ...
         <c:when test="${loginID eq 'admin@admin.com'}">
          <button class="btn" id="modify" type="button">수정</button>
             <button class="btn" id="delete" type="button" style="margin-left:10px;">삭제</button>
            </c:when>
            </c:choose>
              <a href="/list.board?cpage=${cpage}"><button id="back" class="btn" type="button" style="margin-left:10px;">목록</button></a>
            </div>            
        </div>
    </div>
<div class="col-12 d-none d-md-block">
