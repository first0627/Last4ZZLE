...
public class PartyTvingDAO {
	...
	public int createParty() throws Exception {
		String sql = "insert into tvingparty values(tvingparty_seq.nextval,?,?,?,?)";
	...
	public int updateBoss(String boss, int seq) throws Exception {
		String sql = "update tvingparty set boss= ? where seq = ?";
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
	...
	public int seq(String pid) throws Exception {
		String sql = "select parent_seq from tvingpartyboss where ottid = ?";
	...
	public int sizeSeq() throws Exception {
		String sql = "select count(*) from tvingparty";
	...
	public PartyTvingDTO isM1m2m3Exist(int seq) throws Exception {
		String sql = "select boss,m1,m2,m3 from tvingparty where seq = ?";

		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
			pstat.setInt(1, seq);
			try (ResultSet rs = pstat.executeQuery();) {

				PartyTvingDTO dto = new PartyTvingDTO();
				if (rs.next()) {
					String boss = rs.getString("boss");
					String m1 = rs.getString("m1");
					String m2 = rs.getString("m2");
					String m3 = rs.getString("m3");
					dto = new PartyTvingDTO(0, boss, m1, m2, m3);
				}
				return dto;
			}
		}
	...
	public int updateM1(String m1, int seq) throws Exception {
		String sql = "update tvingparty set m1 = ? where seq = ?";
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
	...
	public int updateM2(String m2, int seq) throws Exception {
		String sql = "update tvingparty set m2 = ? where seq = ?";
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
	...
	public int updateM3(String m3, int seq) throws Exception {
		String sql = "update tvingparty set m3 = ? where seq = ?";
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
	...
	public PartyTvingDTO myPartyBoss(String pid) throws Exception {
		String sql = "select * from tvingparty where boss = ?";
	...
	public PartyTvingDTO myPartyMember(String pid) throws Exception {
		String sql = "select * from tvingparty where m1 = ? or m2 = ? or m3 = ?";
