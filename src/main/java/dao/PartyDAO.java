...
public class PartyDAO {
	...
	public int createParty() throws Exception {
		String sql = "insert into party values(party_seq.nextval,?,?,?,?)";
	...
	public int createWatchaParty() throws Exception {
		String sql = "insert into watchaparty values(party_seq.nextval.nextval,?,?,?,?)";
	...
	public int updateBoss(String boss, int seq) throws Exception {
		String sql = "update party set boss= ? where seq = ?";
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
	...
	public PartyDTO isM1m2m3Exist(int seq) throws Exception {
		String sql = "select boss,m1,m2,m3 from party where seq = ?";
	...
	dto = new PartyDTO(0,boss,m1,m2,m3);
				}
				return dto;
			}
		}
	...
	public int updateM1(String m1, int seq) throws Exception {
		String sql = "update party set m1 = ? where seq = ?";
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
	...
	public int updateM2(String m2, int seq) throws Exception {
		String sql = "update party set m2 = ? where seq = ?";
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
	...
	public int updateM3(String m3, int seq) throws Exception {
		String sql = "update party set m3 = ? where seq = ?";
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
	...
	public PartyDTO myPartyBoss(String pid) throws Exception {
		String sql = "select * from party where boss = ?";
	...
	public PartyDTO myPartyMember(String pid) throws Exception {
		String sql = "select * from party where m1 = ? or m2 = ? or m3 = ?";
